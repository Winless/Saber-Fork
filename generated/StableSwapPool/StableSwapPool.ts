...
export class StableSwapPool extends ethereum.SmartContract {
  static bind(address: Address): StableSwapPool {
    return new StableSwapPool("StableSwapPool", address);
  }
  ...
  previous_balances(arg0: BigInt): BigInt {
    let result = super.call(
      "previous_balances",
      "previous_balances(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(arg0)]
    );
  ...
  try_previous_balances(arg0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "previous_balances",
      "previous_balances(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(arg0)]
  ...
  try_block_timestamp_last(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "block_timestamp_last",
      "block_timestamp_last():(uint256)",
      []
